...
export const getImageUrl = (imagePath, category = '') => {
  ...
  let apiBase = import.meta.env.VITE_API_URL || (isProduction ? DEFAULT_PROD_API : DEFAULT_DEV_API);
  if (apiBase && apiBase.includes('mhp-backend-oo30')) {
    apiBase = apiBase.replace('mhp-backend-oo30', 'mhp-backend-ee3o');
  }
